    ...
    class MainActivity : AppCompatActivity() {
        ...
        private val tauxEUR_MDL = 19.26
        private val tauxUSD_RUB = 105.33
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            binding.euroUSD.setOnClickListener { updateLabel(tauxEUR_USD, "Euro", "Dollar")
            }
            binding.euroUAH.setOnClickListener { updateLabel(tauxEUR_MDL, "Euro", "Lei Moldave")
            }
            binding.dollarPeso.setOnClickListener { updateLabel(tauxUSD_RUB, "Dollar", "Rouble Russe")
            }
        }
